        ...
        <Card className="bg-card-color border border-border-color">
            ...
            <CardContent className="space-y-6">
                ...
                <div
                    ...
                    className="h-96 overflow-y-auto border border-border-color rounded-lg p-6 bg-white"
                >
                    <div className="prose prose-sm max-w-none">
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">1. APPOINTMENT & INDEPENDENT CONTRACTOR STATUS</h3>
                        <p className="mb-4">
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">2. TERM AND RENEWAL</h3>
                        <p className="mb-4">
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">3. DUTIES AND RESPONSIBILITIES OF THE SALES AGENT</h3>
                        <p className="mb-2">The Sales Agent shall:</p>
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">4. DUTIES OF THE COMPANY</h3>
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">5. COMMISSION STRUCTURE</h3>
                        <p className="mb-4">
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">6. EXPENSES</h3>
                        <p className="mb-4">
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">7. CONFIDENTIALITY</h3>
                        <p className="mb-4">
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">8. NON-COMPETE</h3>
                        <p className="mb-4">
                        ...
                        <p className="mb-2">This Agreement may be terminated:</p>
                        <ul className="list-disc pl-6 mb-4 space-y-1">
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">10. DISPUTE RESOLUTION</h3>
                        <p className="mb-4">
                        ...
                        <h3 className="text-lg font-semibold mt-6 mb-3">12. ENTIRE AGREEMENT</h3>
                        <p className="mb-6">
